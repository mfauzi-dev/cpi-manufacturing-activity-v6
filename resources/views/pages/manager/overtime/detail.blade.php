...
@section('content')
    ...
    <div class="section-body">
                    ...
                    <div class="card-body">
                        ...
                        @if ($overtime->status === 'PENDING')
                            <div class="text-center">
                                ...
                                <p class="text-muted">
                                    Overtime ini menunggu persetujuan Manager.
                                </p>
        ...
        @if ($overtime->status === 'PENDING')
            <form id="approve-form" action="{{ route('manager.overtime.approve', $overtime->id) }}" method="POST"
                class="d-none">
            ...
            <form id="reject-form" action="{{ route('manager.overtime.reject', $overtime->id) }}" method="POST"
                class="d-none">
