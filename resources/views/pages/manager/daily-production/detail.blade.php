...
@section('content')
    <div class="section-header">
        ...
        <a href="{{ route('manager.daily-production.index') }}" class="text-dark mr-2">
    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form method="GET"
                    action="{{ route('manager.daily-production.detail', [
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('manager.daily-production.detail', [
                            'costCenter' => $costCenter->id,
                            'psGroup' => $psGroup->id,
                        ]) }}"
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="mb-2">
                    ...
                    <a href="{{ route('manager.daily-production.export-excel', [
                    ...
                    <a href="{{ route('manager.daily-production.export-pdf', [
                        'costCenterId' => $costCenter->id,
                        'psGroupId' => $psGroup->id,
                        'date_from' => request('date_from'),
                        'date_to' => request('date_to'),
