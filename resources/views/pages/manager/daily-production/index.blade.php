    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('manager.daily-production.index') }}" method="GET">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('manager.daily-production.index') }}" class="btn btn-secondary">
                            Reset
                        </a>
...
@push('scripts')
    <script>
        ...
        const psGroupsUrlTemplate =
            "{{ route('daily-activity.ps-groups', ['costCenterId' => '__ID__']) }}";
