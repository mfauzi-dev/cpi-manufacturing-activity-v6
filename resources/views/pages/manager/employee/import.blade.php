    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('manager.employee.upload') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group d-none" id="outsourcing-wrapper">
                        ...
                        <select name="outsourcing_id" class="form-control @error('outsourcing_id') is-invalid @enderror">
                            ...
                            @foreach ($outsourcingList as $outsourcing)
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted d-block mt-1">
                            Karyawan hasil import akan otomatis masuk ke department Anda.
                        </small>
                    </div>
