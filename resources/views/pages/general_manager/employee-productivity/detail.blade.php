    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('general-manager.employee-productivity.detail', $employee->id) }}">
                    <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="mb-4">
                    ...
                    <a href="{{ route('general-manager.employee-productivity.export-excel', [
                    ...
                    <a href="{{ route('general-manager.employee-productivity.export-pdf', [
                        'employee_id' => $employee->id,
                        'from' => request('from'),
                        'to' => request('to'),
                    ]) }}"
