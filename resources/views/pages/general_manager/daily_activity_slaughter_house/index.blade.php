    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form action="{{ route('general-manager.daily-activity-slaughter-house.index') }}" method="GET">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('general-manager.daily-activity-slaughter-house.index') }}"
...
@push('scripts')
    <script>
        const costCentersUrlTemplate =
            "{{ route('daily-activity-slaughter-house.cost-centers', ['departmentId' => '__ID__']) }}";

        const psGroupsUrlTemplate =
            "{{ route('daily-activity-slaughter-house.ps-groups', ['costCenterId' => '__ID__']) }}";
