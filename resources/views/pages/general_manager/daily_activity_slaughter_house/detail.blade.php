...
@section('content')
    <div class="section-header">
        ...
        <div>
            <a href="{{ route('general-manager.daily-activity-slaughter-house.index') }}" class="text-dark mr-2">
    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form method="GET"
                    action="{{ route('general-manager.daily-activity-slaughter-house.detail', [
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="mb-2">
                    ...
                    <a href="{{ route('general-manager.daily-activity-slaughter-house.export-excel', [
                    ...
                    <a href="{{ route('general-manager.daily-activity-slaughter-house.export-pdf', [
                        'costCenterId' => $costCenter->id,
                        'psGroupId' => $psGroup->id,
                        'line_id' => $line->id ?? null,
                        'date_from' => request('date_from'),
