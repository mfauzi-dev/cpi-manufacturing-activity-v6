...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <form action="{{ route('admin.wage-config.update', $wageConfig->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Tahun</label>
                        <input type="number" name="tahun" value="{{ old('tahun', $wageConfig->tahun) }}"
                    ...
                    <div class="form-group">
                        <label>UMP (Rp)</label>
                        <input type="number" step="0.01" name="ump" value="{{ old('ump', $wageConfig->ump) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="hari_kerja_standar"
                            value="{{ old('hari_kerja_standar', $wageConfig->hari_kerja_standar) }}"
