...
@section('content')
    ...
    <div class="section-body">
        ...
        <a href="{{ route('admin.level.create') }}" class="btn btn-primary mb-4">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.level.index') }}" method="GET">
                    <div class="row g-2">

                        <div class="col-lg col-md-4 mb-3">
                            <input type="text" name="search" class="form-control" placeholder="Cari nama level.."
                                value="{{ $search ?? '' }}">
                        </div>
