...
@section('content')
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('admin.payroll.bulanan.index') }}">Payroll</a></div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.payroll.bulanan.generate') }}" method="POST">
                @csrf
                ...
                <a href="{{ route('admin.payroll.bulanan.index') }}" class="btn btn-secondary">
                    Cancel
                </a>
