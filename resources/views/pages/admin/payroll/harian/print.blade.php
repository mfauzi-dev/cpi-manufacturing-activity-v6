...
<body>
    ...
    <div class="slip-body">
        ...
        <div class="slip-col">
            ...
            <table>
                <tr>
                    <td>Total Earning ({{ $payroll->work_days }} hari kerja)</td>
                    <td class="num">Rp {{ number_format($payroll->total_earning, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td>Total KG</td>
                    <td class="num">{{ number_format($payroll->total_kg, 2, ',', '.') }} kg</td>
                </tr>
                <tr class="total">
        ...
        <div class="slip-col">
            ...
            <table>
                <tr>
                    ...
                    <td class="num">Rp {{ number_format($payroll->management_fee, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td>BPJS Kesehatan</td>
                    <td class="num">Rp {{ number_format($payroll->bpjs_kesehatan, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <td>BPJS Ketenagakerjaan</td>
                    <td class="num">Rp {{ number_format($payroll->bpjs_ketenagakerjaan, 0, ',', '.') }}</td>
                </tr>
                <tr class="total">
                    <td>Total Potongan</td>
                    <td class="num">Rp
                        {{ number_format($payroll->management_fee + $payroll->bpjs_kesehatan + $payroll->bpjs_ketenagakerjaan, 0, ',', '.') }}
                    </td>
                </tr>
            </table>
        </div>
