...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <form action="{{ route('admin.overtime.update', $overtime->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="employee_id"
                            ...
                            <option value="{{ $overtime->employee_id }}" selected>
                                {{ $overtime->employee->name }} - {{ $overtime->employee->nik }}
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="work_date"
                            value="{{ old('work_date', $overtime->work_date->format('Y-m-d')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="rate_per_hour"
                            value="{{ old('rate_per_hour', (int) $overtime->rate_per_hour) }}"
                    ...
                    <div class="form-group">
                        <label>Notes</label>
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $overtime->notes) }}</textarea>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            @if (old('employee_id') && old('employee_name'))
