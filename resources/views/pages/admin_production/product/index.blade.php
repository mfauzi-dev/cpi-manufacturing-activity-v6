...
@section('content')
    ...
    <div class="section-body">
        <a href="{{ route('admin-production.product.create') }}" class="btn btn-primary mb-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin-production.product.index') }}" method="GET">
                <div class="row g-2">
                ...
                <div class="mt-2">
                    ...
                    <a href="{{ route('admin-production.product.index') }}" class="btn btn-secondary">Reset</a>
                </div>
                    ...
                    <tbody>
                        @forelse ($products as $index => $product)
                            <tr>
                                ...
                                <td>Rp {{ $product->harga_per_kg }}</td>
                                <td class="text-center">
                                    <a href="{{ route('admin-production.product.edit', $product->id) }}"
                                        class="btn btn-warning btn-sm">
                                        Edit
                                    </a>
                                    <form action="{{ route('admin-production.product.destroy', $product->id) }}"
