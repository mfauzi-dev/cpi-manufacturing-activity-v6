...
@section('content')
    ...
    <a href="{{ route('admin-production.daily-earning.create') }}" class="btn btn-primary mb-4">
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('admin-production.daily-earning.index') }}">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('admin-production.daily-earning.index') }}" class="btn btn-secondary">
                            Reset
                        </a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('admin-production.daily-earning.show', $item->id) }}"
                                            class="btn btn-sm btn-primary mr-2">
                                            Lihat
                                        </a>

                                        <a href="{{ route('admin-production.daily-earning.edit', $item->id) }}"
