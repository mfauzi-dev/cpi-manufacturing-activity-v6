...
@section('content')
    <div class="section-header">
        <h1>Product Slaughter House</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Product Slaughter House</a></div>
            <div class="breadcrumb-item"><a href="#">Table</a></div>
        </div>
    </div>

    <div class="section-body">
        <a href="{{ route('admin-production.product-slaughter-house.create') }}" class="btn btn-primary mb-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin-production.product-slaughter-house.index') }}" method="GET">
                <div class="row g-2">
                ...
                <div class="mt-2">
                    ...
                    <a href="{{ route('admin-production.product-slaughter-house.index') }}"
    ...
    <div class="card">
        <div class="card-header">
            <h4>Daftar Product Slaughter House</h4>
        </div>
                    ...
                    <tbody>
                        @forelse ($products as $index => $product)
                            <tr>
                                ...
                                <td>{{ $product->harga_per_kg ?? '-' }}</td>
                                <td>{{ $product->productivity ?? '-' }}</td>
                                <td class="text-center">
                                    <a href="{{ route('admin-production.product-slaughter-house.edit', $product->id) }}"
                                        class="btn btn-warning btn-sm">
                                        Edit
                                    </a>
                                    <form
                                        action="{{ route('admin-production.product-slaughter-house.destroy', $product->id) }}"
