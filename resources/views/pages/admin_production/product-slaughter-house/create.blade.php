...
@section('title', 'Create Product Slaughter House')

@section('content')

    <div class="section-header">
        <h1>Create Product Slaughter House</h1>
    </div>

    <div class="card">
        <div class="card-body">

            <form action="{{ route('admin-production.product-slaughter-house.store') }}" method="POST">
                @csrf
