...
@section('title', 'Edit Product Slaughter House')

@section('content')

    <div class="section-header">
        <h1>Edit Product Slaughter House</h1>
    </div>

    <div class="card">
        <div class="card-body">

            <form action="{{ route('admin-production.product-slaughter-house.update', $product->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="harga_per_kg"
                        value="{{ old('harga_per_kg', $product->harga_per_kg) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="productivity"
                        value="{{ old('productivity', $product->productivity) }}"
                ...
                <a href="{{ route('admin-production.product-slaughter-house.index') }}" class="btn btn-secondary">
                    Batal
                </a>
            </form>
