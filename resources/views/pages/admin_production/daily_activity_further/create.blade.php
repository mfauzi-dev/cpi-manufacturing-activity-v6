                    ...
                    <table class="table table-bordered" id="detailTable" style="table-layout: fixed;">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th width="150">Total KG</th>
                                <th width="150">Lama Packing</th>
                                <th width="150">Productivity</th>
...
@push('scripts')
    <script>
        ...
        $(document).on('keyup change', '.output-kg, .lama-packing', function() {
            hitungProductivity($(this).closest('tr'));
        });

        function hitungProductivity(row) {
            ...
            <tr data-row-index="${rowIndex}">
                ...
                <td>
                    <input type="number" step="0.01" min="0"
                        name="details[${rowIndex}][total_kg]" class="form-control output-kg">
                </td>
