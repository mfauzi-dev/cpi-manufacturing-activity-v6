    ...
    <div class="section-body">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('admin-production.employee-productivity.detail', $employee->id) }}">
                    <div class="row">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('admin-production.employee-productivity.detail', $employee->id) }}"
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <div class="mb-4">
                    ...
                    <a href="{{ route('admin-production.employee-productivity.export-excel', [
                    ...
                    <a href="{{ route('admin-production.employee-productivity.export-pdf', [
                        'search' => $employee->name,
                        'employee_id' => $employee->id,
                        'from' => request('from'),
                        'to' => request('to'),
